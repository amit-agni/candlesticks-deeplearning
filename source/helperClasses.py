...
class printLR_Callback(tf.keras.callbacks.Callback):  
    ''' Prints learning rate before every epoch
    '''
...
class haltCallback(tf.keras.callbacks.Callback):
    ''' Stops training when a certain loss if reached
    '''
...
class MemCleanupCallback(tf.keras.callbacks.Callback):
    ''' Cleanup memory after every epoch
    '''
